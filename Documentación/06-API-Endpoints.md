...
| `admin-metrics` | Métricas de rendimiento del admin (service role): M1 Ocupación, M2 Conversión, M3 Asistencia, M5 Pagos exitosos, **globales y por sede** (M4 Disponibilidad es uptime externo, no se calcula). No-admin → 403 |
