<template>
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    ...
    <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      <div class="card">
        <h3 class="text-gray-400 text-sm mb-1">Total Clases</h3>
        <p class="text-3xl font-bold text-white">{{ metrics.totalClases || 0 }}</p>
      </div>
      <div class="card">
        <h3 class="text-gray-400 text-sm mb-1">Clases este mes</h3>
      ...
      <div class="card">
        <h3 class="text-gray-400 text-sm mb-1">Clases Activas</h3>
