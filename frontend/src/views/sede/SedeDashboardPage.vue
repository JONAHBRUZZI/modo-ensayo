<template>
  ...
  >
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <router-link to="/sede/metricas" class="card hover:border-primary/50 transition-colors group"><h3 class="text-lg font-semibold text-white group-hover:text-primary">Métricas</h3><p class="text-gray-400 text-sm mt-2">Rendimiento de tu sede.</p></router-link>
      <router-link to="/sede/configuracion" class="card hover:border-primary/50 transition-colors group"><h3 class="text-lg font-semibold text-white group-hover:text-primary">Configuración</h3><p class="text-gray-400 text-sm mt-2">Datos de tu sede.</p></router-link>
