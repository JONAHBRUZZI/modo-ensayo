-- ============================================================
-- Detalle de una clase de la sede + sus alumnos (para "Clases de mi Sede")
-- ============================================================
-- El admin de sede no puede leer enrollments/attendances directamente (RLS),
-- así que estas funciones SECURITY DEFINER exponen el detalle SOLO de clases
-- cuyas salas pertenecen a una sede que el usuario administra.
-- ============================================================

-- Info completa de la clase + profesor + cupos.
...
-- Alumnos/beneficiarios inscritos en la clase (+ asistencia si ya se marcó).
